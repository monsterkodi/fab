...
func setBeltColors():        setColors(Color(0.15, 0.15, 0.15), Color(0.1,0.1,0.1))
func setBeltBuilderColors(): setColors(Color(0.368, 0.38, 1.0), Color(0.75, 0.75, 3.0))
func setRectSelectColors():  setColors(Color(0.829, 0.829, 0.829), Color(0.2, 0.2, 0.2))
